...
struct shot
{
    ...
    // Time-stop knife data
    float timeStopTimer;
    float timeStopDuration;
    sfBool hasTimeStopped;
    sfVector2f storedVelocity;

    // Backdoor portal data
    float backdoorTimer;
    float backdoorTeleportTime;
    sfBool hasTeleported;
    sfBool isInvisible;
    int portalIndex;
    int targetPortalIndex;
    sfVector2f teleportPos;
